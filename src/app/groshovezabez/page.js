...
<Callpg></Callpg>
      ...
      <div className="about">
        ...
        <hr></hr>
        <h2 className="font-h5">ВІДПОВІДНО ДО ЧИННОГО ЗАКОНОДАВСТВА УКРАЇНИ, ВІЙСЬКОВОСЛУЖБОВЦІ ПОВИННІ МАТИ ДОСТАТНІЙ РІВЕНЬ ГРОШОВОГО ЗАБЕЗПЕЧЕННЯ, А У РАЗІ ВЕДЕННЯ ВІЙСЬКОВОГО СТАНУ МАЮТЬ ПРАВО НА ДОДАТКОВУ ВИНАГОРОДУ ЗА НАСТУПНИХ ПІДСТАВ:</h2>
<div className="about-main">
<div className="p-text-enb">
<p className="font-text-18px-regular">- Перебування в зоні бойових дій (Бойові).</p>
<p className="font-text-18px-regular">- Стаціонарне лікування внаслідок поранення у лікувальних закладах.</p>
<p className="font-text-18px-regular">- Не вірне застосування законодавства військово - лікарською комісією.</p>
<p className="font-text-18px-regular">- Перебування у відпустці за станом здоров’я.</p>
</div>
...
<p className="font-text-18px-regular">Нажаль не завжди фінансова частина нараховує всі відповідні виплати.
