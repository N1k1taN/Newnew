...
<Callpg></Callpg>
      ...
      <div className="about">
        ...
        <hr></hr>
        <h2 className="font-h4">РІШЕННЯ ВІЙСЬКОВО-ЛІКАРСЬКОЇ КОМІСІЇ ПІДЛЯГАЄ ОСКАРЖЕННЮ В НАСТУПНИХ ВИПАДКАХ:</h2>
<div className="about-main">
<div className="p-text-enb">
<p className="font-text2">- Необ'єктивність лікарської комісії. </p>
<p className="font-text2">- Порушення процедури проведення ВЛК.</p>
<p className="font-text2">- Не вірне застосування законодавства військово
лікарською комісією.</p>
<p className="font-text2">- Незаконне рішення ВЛК.</p>
<p className="font-text2">- Помилковий причинний звʼязок захворювання (травми).</p>
<p className="font-text2">- Не вірно вказана ступень тяжкості поранення.</p>
</div>
...
<p className="font-text4 textbeg">Не рідко військово - лікарська комісія упереджено та не обʼєктивно проводить огляд військового або військо-возобовʼязаного, внаслідок чого приймає незаконне рішення. Тому, в ході оскарження рішення ВЛК наша 
