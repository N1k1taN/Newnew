  ...
  return (
    ...
    <Callpg></Callpg>
          ...
          <div className="about">
            ...
            <hr></hr>
            <h2 className="font-h4">ВІДПОВІДНО ДО КОДЕКСУ УКРАЇНИ АДМІНІСТРАТИВНІ ПРАВОПОРУШЕННЯ ПЕРЕДБАЧЕНА МОЖЛИВІСТЬ НАКЛАДЕННЯ АДМІНІСТРАТИВНОГО ШТРАФУ ЗА ПОРУШЕННЯ ПРАВИЛ ВІЙСЬКОВОГО ОБЛІКУ:</h2>
    <div className="about-main">
    <div className="p-text-enb">
    <p className="font-text2">- За неявку до ТЦК за повісткою передбачено від 17 000 до 25 000 грн за перше правопорушення, а також від 34 000 до 59 500 грн - для посадових і юридичних осіб</p>
    </div>
    <div className="about-text">
      <div className="p-text-dis">
      <p className="font-text2">- За неявку до ТЦК за повісткою передбачено від 17 000 до 25 000 грн за перше правопорушення, а також від 34 000 до 59 500 грн - для посадових і юридичних осіб</p>
    </div>
    <p className="font-text4 textbeg">
