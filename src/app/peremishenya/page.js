  ...
  return (
    ...
    <Callpg></Callpg>
          ...
          <div className="about">
            ...
            <hr></hr>
            <h2 className="font-h5">ПОРЯДОК ПЕРЕМІЩЕННЯ ВІЙСЬКОВОСЛУЖБОВЦІВ ДО ІНШОЇ ВІЙСЬКОВОЇ ЧАСТИНИ ПЕРЕДБАЧЕНО ТА РОЗГЛЯД ТАКИХ РАПОРТІВ ПЕРЕДБАЧЕНО:</h2>
    <div className="about-main">
    <div className="p-text-enb">
    <p className="font-text-18px-regular">- Численними законодавчими актами України, у тому числі законами Верховної Ради, постановами Кабінету Міністрів, наказами Міністра Оборони. </p>
    </div>
    <div className="about-text">
      <div className="p-text-dis">
    <p className="font-text-18px-regular">- Численними законодавчими актами України, у тому числі законами Верховної Ради, постановами Кабінету Міністрів, наказами Міністра Оборони.</p>
    </div>
    <p className="font-text-18px-regular textbeg">Та не дивлячись про те, що існує мобільний застосунок для військовослужбовців Армія +, проблем в цьому питанні менше не стало.
