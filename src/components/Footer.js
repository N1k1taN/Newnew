...
<div className="contact">
  <h2 className="font-foz">Контакти</h2>
  <a className="font-foinfo" href="tel:+380937452557"><img></img>+380937452557</a>
  <a className="font-foinfo"><img></img>nlawcompany@gmail.com</a>
  </div>
<div className="grafik">
<h2 className="font-foz">Графік</h2>
  <h3 className="font-foinfo">Пн-Пт     10:00 по 19:00</h3>
  <h3 className="font-foinfo">Сб-Нд     по домовленості</h3>
</div>
